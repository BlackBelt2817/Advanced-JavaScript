...
let checkPassword = function comparePasswords(passwordToCompare) {
  checkPassword = (password) => {
...
// .call
checkPassword.call(me.password);

// .apply
checkPassword.apply(me.password);

// .bind
checkPassword.bind(me.password);
